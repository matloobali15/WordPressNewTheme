...
<form role="search" <?php echo $botiga_aria_label; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Escaped above. ?> method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<?php do_action( 'botiga_searchform_before_form_content' ); ?>
	...
	<?php do_action( 'botiga_searchform_after_form_content' ); ?>
	<?php do_action( 'botiga_searchform_before_close_form' ); ?>
</form>
<?php else : ?>
<form role="search" method="get" class="woocommerce-product-search" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<?php do_action( 'botiga_searchform_after_form_content' ); ?>
	<?php do_action( 'botiga_shop_searchform_before_close_form' ); ?>
</form>
<?php endif; ?>